...
In this section, we will explore \underline{multilinear algebra}, that is, the algebra of tensors.

For this discussion, let \(V\) be a vector space over \(\reals\), and consider elements of \(V^k = V \times ... \times V\) (\(k\)-times).
\begin{definition}
